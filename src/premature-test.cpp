...
static void
runtest(const char *query, const char *bind_before, const char *bind_after, int execute)
{
	SQLRETURN	rc;
	HSTMT		hstmt;
	SQLLEN		cbParam1;
	...
	if (bind_before)
	{
		...
		rc = SQLBindParameter(hstmt, 1, SQL_PARAM_INPUT,
						  ...
						  20,			/* column size */
						  0,			/* dec digits */
						  (SQLCHAR*)bind_before,	/* param value ptr */
						  0,			/* buffer len */
	...
	if (bind_after)
	{
		...
		rc = SQLBindParameter(hstmt, 1, SQL_PARAM_INPUT,
						  ...
						  20,			/* column size */
						  0,			/* dec digits */
						  (SQLCHAR*)bind_after,	/* param value ptr */
						  0,			/* buffer len */
						  &cbParam1		/* StrLen_or_IndPtr */);
		CHECK_STMT_RESULT(rc, "SQLBindParameter failed", hstmt);
	}
