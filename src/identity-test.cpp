...
TEST_CASE("identity-test", "[odbc]") {
	...
	test_identity_col(
		...
		"CREATE TEMPORARY TABLE tmptable (id int primary key, t text)",
		"INSERT INTO tmptable (id, t) VALUES (1, 'simple')",
		"SELECT * FROM tmptable");

	test_identity_col(
		v10 ?
		"CREATE TEMPORARY TABLE tmptable2 (id int generated always as identity primary key, t text)" :
		"CREATE TEMPORARY TABLE tmptable2 (id int primary key, t text)",
		"INSERT INTO tmptable2 (id, t) VALUES (1, 'value.with.dots')",
		"SELECT * FROM tmptable2");

	test_identity_col(
		v10 ?
		"CREATE TEMPORARY TABLE \"tmp table\" (id int generated by default as identity primary key, t text)" :
		"CREATE TEMPORARY TABLE \"tmp table\" (id int primary key, t text)",
		"INSERT INTO \"tmp table\" (id, t) VALUES (1, 'space in table name')",
