This is a clone of the [PostgreSQL ODBC driver](https://www.postgresql.org/ftp/odbc/versions/src/). Specifically, this repo contains the tests that are defined there.
